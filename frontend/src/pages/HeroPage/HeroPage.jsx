...
const HeroPage = () => {
  ...
  const getWeatherData = async (cityName) => {
    ...
    if (data !== null) {
      ...
      setError(
        "This place is not available or not found. Please try another city."
      );
    }
  };
  ...
  return (
    <>
      <div className="h-fit">
        ...
        <p
          className={`text-sm mx-10 pt-3 text-red-500 error-msg ${
            error ? "visible" : ""
          }`}
        >
          {error || "\u00A0"}
        ...
        <div className="max-w-7xl mx-auto h-fit"></div>
        <div className="bg-transparent min-h-screen px-4 py-2">
          {/* Hero Weather Display */}
          <div className="text-center mb-16">
            <h1 className="text-8xl md:text-9xl font-light font-serif text-gray-100 mb-4 tracking-tight">
              {Math.round(temperature)} <span className="text-6xl">°c</span>
            </h1>
            ...
            <div className="space-y-2">
              ...
              <p className="text-lg text-gray-400 capitalize font-medium">
                {description}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            <div className="lg:col-span-1 bg-blur text-white rounded-3xl p-8 border border-blue-200/50 shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-sm text-gray-100 font-medium">Real feel temperature</p>
            </div>
            ...
            <div className="bg-transparent rounded-3xl p-8 border border-cyan-200/50 shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-sm text-gray-100 font-medium">Moisture in air</p>
            </div>
            ...
            <div className="bg-transparent rounded-3xl p-8 border border-green-200/50 shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-sm text-gray-100 font-medium">m/s</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-transparent rounded-2xl p-6 border border-gray-200/60 shadow-sm hover:shadow-md transition-all duration-300">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-100 font-medium">Visibility</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-transparent rounded-2xl p-6 border border-gray-200/60 shadow-sm hover:shadow-md transition-all duration-300">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-100 font-medium">Pressure (hPa)</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-transparent rounded-2xl p-6 border border-gray-200/60 shadow-sm hover:shadow-md transition-all duration-300">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <p className="text-2xl font-medium text-gray-100">{clouds}%</p>
                  <p className="text-md font-medium text-gray-100">Cloud Cover</p>
                </div>
              </div>
            </div>
          </div>
